...
class __TwigTemplate_1cb917c785595d21b7464c72f5e9f1239be54290a0aac514531846b71ade8250 extends Twig_Template
{
...
";
    ...
    public function getdisplay_message($_log_index = null, $_log = null)
    {
        ...
        ";
            ...
            ";
                        // line 116
                        echo ((((isset($context["index"]) ? $context["index"] : $this->getContext($context, "index")) == (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["log"]) ? $context["log"] : $this->getContext($context, "log")), "context", array()), "stack", array())) - 1))) ? ("</ul>") : (""));
                        echo "
        ";
                    }
                }
