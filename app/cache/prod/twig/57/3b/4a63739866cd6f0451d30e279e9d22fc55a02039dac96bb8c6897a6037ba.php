...
class __TwigTemplate_573b4a63739866cd6f0451d30e279e9d22fc55a02039dac96bb8c6897a6037ba extends Twig_Template
{
        ...
        if ((isset($context["previous_count"]) ? $context["previous_count"] : null)) {
            ...
            foreach ($context['_seq'] as $context["i"] => $context["previous"]) {
                ...
                echo "                            <li>
                                ";
                // line 25
                echo $this->env->getExtension('code')->abbrClass($this->getAttribute((isset($context["previous"]) ? $context["previous"] : null), "class", array()));
